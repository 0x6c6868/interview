...
public class _32_2_PrintTreesInLines {
    ...
    public static void test1() {
        ...
        try {
            ...
            if (rst.get(0).get(0) != 8) flag = false;

            if (rst.get(1).get(0) != 6) flag = false;
            if (rst.get(1).get(1) != 10) flag = false;

            if (rst.get(2).get(0) != 5) flag = false;
            if (rst.get(2).get(1) != 7) flag = false;
            if (rst.get(2).get(2) != 9) flag = false;
            if (rst.get(2).get(3) != 11) flag = false;
    ...
    public static void test2() {
        ...
        try {
            ...
            if (rst.get(0).get(0) != 5) flag = false;
            if (rst.get(1).get(0) != 4) flag = false;
            if (rst.get(2).get(0) != 3) flag = false;
            if (rst.get(3).get(0) != 2) flag = false;
    ...
    public static void test6() {
        ...
        try {
            ...
            boolean flag = true;
            if (rst.get(0).get(0) != 100) flag = false;
            if (rst.get(1).get(0) != 50) flag = false;
            if (rst.get(2).get(0) != 150) flag = false;
